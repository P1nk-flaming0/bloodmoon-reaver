...
Run from repo root:
  python tools/compose_background.py
"""
...
def main() -> None:
    ...
    full_png = os.path.join(IMG, "site-background.png")
    full_jpg = os.path.join(IMG, "site-background.jpg")
    left_path = os.path.join(IMG, "site-background-left.png")
    right_path = os.path.join(IMG, "site-background-right.png")

    final.save(full_png, "PNG", optimize=True)
    final.save(full_jpg, "JPEG", quality=86, optimize=True)
